...
import com.example.capstone.video_quiz.Cashier_QuizActivity
...
class CashierActivity : AppCompatActivity() {
    ...
    private var videoIds = listOf("enkCVIHj2zk","Nkbzp_vjS7o")
            ...
            override fun onYouTubePlayer(youTubePlayer: YouTubePlayer) {
                ...
                nextButton.setOnClickListener {
                    ...
                    if (currentVideoIndex >= videoIds.size) {
                        // 전환할 액티비티로 화면 전환
                        val intent = Intent(this@CashierActivity, Cashier_QuizActivity::class.java)
